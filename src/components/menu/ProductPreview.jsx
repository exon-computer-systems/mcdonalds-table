      ...
      <section className={styles.product_preview}>
        <section className={styles.pp_heading_cont}>
          ...
          <section className={styles.pp_heading}>
            ...
            >
              {`${item.itemName} ${
                selectedSize.capacity ? selectedSize.capacity + "l" : ""
              }`}
            </h2>
          ...
          <section className={styles.pp_info}>
            <section className={styles.pp_info_content}>
              {/* <section className={styles.pp_info_size_cont}>
                <section className={styles.pp_info_size2}>
                  {item.flavors?.map((el) => (
                    <span className={styles.pp_info_size_btn_cont}>
                      <button
                        className={`${styles.pp_info_size_btn} ${
              ...
              <section className={styles.pp_info_size_cont}>
                <section className={styles.pp_info_size}>
                  {item.options?.map((el) => {
                    const priceDiff = el.itemPrice - selectedSize.itemPrice;
                    ...
                    return (
                      ...
                      >
                        ...
                        <p className={styles.pp_info_size_price}>
                          {priceDiff > 0 && "+"}
                          {priceDiff !== 0 &&
                            `${parseFloat(priceDiff).toFixed(2)} zł`}
                        </p>
                      </span>
                    );
                  })}
              ...
              <section className={styles.pp_count_cont}>
                <section className={styles.pp_count}>
                  ...
                  <span className={styles.pp_count_counter}>{itemOrder}</span>
                  <button
                    className={`${styles.pp_count_btn}`}
        ...
        <section className={styles.pp_image_btn_cont}>
          ...
          >
            Dodaj do zamówienia <FontAwesomeIcon icon={faCartPlus} />
          </button>
        </section>
      </section>
    </section>
